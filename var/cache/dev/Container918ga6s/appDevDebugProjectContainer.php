...
class appDevDebugProjectContainer extends Container
{
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('8h8A+VYzjk', 0, ($this->targetDirs[0].'/pools'));
    ...
    {
        return $this->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('CMw3NFvOt4', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    protected function getTwigService()
    {
        ...
        $instance->addExtension(${($_ = isset($this->services['skies_barcode.twig.extension']) ? $this->services['skies_barcode.twig.extension'] : $this->getSkiesBarcode_Twig_ExtensionService()) && false ?: '_'});
    ...
    {
        return $this->services['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('3dcrnRJsbH', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('1KYY5w1zun', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    /**
     * Gets the private 'skies_barcode.generator' shared service.
     *
    ...
    /**
     * Gets the private 'skies_barcode.twig.extension' shared service.
     *
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\ProduitBundle/Resources/views'), '!Produit');
        $instance->addPath(($this->targetDirs[3].'\\src\\PromotionBundle/Resources/views'), 'Promotion');
        $instance->addPath(($this->targetDirs[3].'\\src\\PromotionBundle/Resources/views'), '!Promotion');
        $instance->addPath(($this->targetDirs[3].'\\src\\SavBundle/Resources/views'), 'Sav');
        $instance->addPath(($this->targetDirs[3].'\\src\\SavBundle/Resources/views'), '!Sav');
        $instance->addPath(($this->targetDirs[3].'\\vendor\\knplabs\\knp-paginator-bundle/Resources/views'), 'KnpPaginator');
        $instance->addPath(($this->targetDirs[3].'\\vendor\\knplabs\\knp-paginator-bundle/Resources/views'), '!KnpPaginator');
        $instance->addPath(($this->targetDirs[3].'\\src\\ServiceBundle/Resources/views'), 'Service');
        $instance->addPath(($this->targetDirs[3].'\\src\\ServiceBundle/Resources/views'), '!Service');
        $instance->addPath(($this->targetDirs[3].'\\src\\AvisserviceBundle/Resources/views'), 'Avisservice');
        $instance->addPath(($this->targetDirs[3].'\\src\\AvisserviceBundle/Resources/views'), '!Avisservice');
    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'kernel.bundles_metadata': $value = [
                ...
                'PromotionBundle' => [
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'\\src\\PromotionBundle'),
                    'namespace' => 'PromotionBundle',
                ],
                'SavBundle' => [
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'\\src\\SavBundle'),
                    'namespace' => 'SavBundle',
                ],
                'KnpSnappyBundle' => [
                    'parent' => NULL,
                    'path' => 'C:/wamp64/www/final_pepiniere/vendor/knplabs/knp-snappy-bundle',
                ...
                'ServiceBundle' => [
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'\\src\\ServiceBundle'),
                    'namespace' => 'ServiceBundle',
                ],
                'AvisserviceBundle' => [
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'\\src\\AvisserviceBundle'),
                    'namespace' => 'AvisserviceBundle',
                ],
                'SkiesQRcodeBundle' => [
                    'parent' => NULL,
    ...
    protected function getDefaultParameters()
    {
        return [
            ...
            'kernel.bundles' => [
                ...
                'PromotionBundle' => 'PromotionBundle\\PromotionBundle',
                'SavBundle' => 'SavBundle\\SavBundle',
                ...
                'AvisserviceBundle' => 'AvisserviceBundle\\AvisserviceBundle',
            ...
            'mailer_user' => 'sunflower.thesquad',
            'mailer_password' => 'wa7edthnen',
            ...
            'swiftmailer.mailer.default.transport.smtp.username' => 'sunflower.thesquad@gmail.com',
            'swiftmailer.mailer.default.transport.smtp.password' => 'wa7edthnen',
            ...
            'fos_user.model.user.class' => 'ForumBundle\\Entity\\User',
            ...
            'notifications' => [
                'app_id' => '762975',
                'app_key' => '85d4e50c09d1a2b43a22',
                'app_secret' => 'c1c76da79c19e6b776f7',
                'cluster' => 'eu',
                'encrypted' => false,
            ],
