...
$c = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver(${($_ = isset($this->services['annotation_reader']) ? $this->services['annotation_reader'] : $this->getAnnotationReaderService()) && false ?: '_'}, [0 => ($this->targetDirs[3].'\\src\\ForumBundle\\Entity'), 1 => ($this->targetDirs[3].'\\src\\EvenementBundle\\Entity'), 2 => ($this->targetDirs[3].'\\src\\CommandeBundle\\Entity'), 3 => ($this->targetDirs[3].'\\src\\ProduitBundle\\Entity'), 4 => ($this->targetDirs[3].'\\src\\PromotionBundle\\Entity'), 5 => ($this->targetDirs[3].'\\src\\SavBundle\\Entity'), 6 => ($this->targetDirs[3].'\\src\\ServiceBundle\\Entity'), 7 => ($this->targetDirs[3].'\\src\\AvisserviceBundle\\Entity')]);
...
$b->addDriver($c, 'PromotionBundle\\Entity');
$b->addDriver($c, 'SavBundle\\Entity');
$b->addDriver($c, 'ServiceBundle\\Entity');
$b->addDriver($c, 'AvisserviceBundle\\Entity');
...
$a->setEntityNamespaces(['ForumBundle' => 'ForumBundle\\Entity', 'EvenementBundle' => 'EvenementBundle\\Entity', 'CommandeBundle' => 'CommandeBundle\\Entity', 'ProduitBundle' => 'ProduitBundle\\Entity', 'PromotionBundle' => 'PromotionBundle\\Entity', 'SavBundle' => 'SavBundle\\Entity', 'ServiceBundle' => 'ServiceBundle\\Entity', 'AvisserviceBundle' => 'AvisserviceBundle\\Entity']);
