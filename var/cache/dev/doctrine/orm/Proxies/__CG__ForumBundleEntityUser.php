 ...
 */
class User extends \ForumBundle\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', '' . "\0" . 'ForumBundle\\Entity\\User' . "\0" . 'nom', '' . "\0" . 'ForumBundle\\Entity\\User' . "\0" . 'prenom', '' . "\0" . 'ForumBundle\\Entity\\User' . "\0" . 'sexe', '' . "\0" . 'ForumBundle\\Entity\\User' . "\0" . 'dateDeNaissance', '' . "\0" . 'ForumBundle\\Entity\\User' . "\0" . 'adresse', 'username', 'usernameCanonical', 'email', 'emailCanonical', 'enabled', 'salt', 'password', 'plainPassword', 'lastLogin', 'confirmationToken', 'passwordRequestedAt', 'groups', 'roles'];
        }
