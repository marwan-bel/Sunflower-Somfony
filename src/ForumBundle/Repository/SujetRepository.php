...
/// //////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    public function listSujetByNomCateg($nomCateg)
    {
        $query = $this->getEntityManager()->createQuery("select s from ForumBundle:Sujet s where s.nomCategorieSujet=$nomCateg");
        return $query->getResult();
    }

    public function listNomCateg()
    {
        $query = $this->getEntityManager()->createQuery("select s.nomCategorieSujet from ForumBundle:CategorieSujet s ");
        return $query->getResult();
    }
