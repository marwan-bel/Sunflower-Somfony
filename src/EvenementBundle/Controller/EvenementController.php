...
//click participer render a la page tous les eve (front)
    ...
    public function AffichermobileAction()
    {
        ...
        $Hotes = $this->getDoctrine()->getManager()
            ->getRepository('EvenementBundle:Evenement')->listevent();

        $serializer = new Serializer([new ObjectNormalizer()]);
        $formatted = $serializer->normalize($Hotes);
        return new JsonResponse($formatted);


    }

    public function AfficherrechmobileAction(Request $request)
    {



        $Hotes = $this->getDoctrine()->getRepository(Evenement::class)->findBy(array('nomEvenement' => $request->get('nomeve')));
    ...
    public function nbrparmobileAction(Request $request)
    {

        $em = $this->getDoctrine()->getManager();
        $nbr = $em->getRepository('EvenementBundle:Participer')->rechercheparticiperideve($request->get('ideve'));//nbr participons a une eve


        $serializer = new Serializer([new ObjectNormalizer()]);
        $formatted = $serializer->normalize($nbr);
        return new JsonResponse($formatted);
    ...
    public function verifmobileAction(Request $request)
    {

        $em = $this->getDoctrine()->getManager();
        $nbr = $em->getRepository('EvenementBundle:Participer')->rechercheparticiperideve($request->get('ideve'));//nbr participons a une eve
        $nbrr = $em->getRepository('EvenementBundle:Participer')->rechercheparticiperid($request->get('iduser'), $request->get('ideve'));//user est participer au eve =1 sinon 0

        $evenement = $this->getDoctrine()->getRepository(Evenement::class)->find($request->get('ideve'));
    ...
    public function ajouterparmobileAction(Request $request)
    {
        $em = $this->getDoctrine()->getManager();
    ...
    public function supprimerparmobileAction(Request $request)
    {
        $em = $this->getDoctrine()->getManager();
        ...
        $nbrrr = $em->getRepository('EvenementBundle:Participer')->rechercheparticiperidd($request->get('iduser'), $request->get('ideve'));//recuperer id_par selon id_user et id_eve
        $pa = $this->getDoctrine()->getRepository(Participer::class)->find($nbrrr);//recuperer l objet participer
        $participer->setIdParticiper($nbrrr);
    ...
    public function verifevemobileAction(Request $request)
    {

        $em = $this->getDoctrine()->getManager();
        $nbr = $em->getRepository('EvenementBundle:LikeEve')->rechercherlike($request->get('ideve'),$request->get('iduser'));//nbr participons a une eve
        ...
        {
            $ty = $em->getRepository('EvenementBundle:LikeEve')->rechercherliketype($request->get('ideve'),$request->get('iduser'));//nbr participons a une eve
    ...
    public function ajouterlikemobileAction(Request $request)
    {
        $em = $this->getDoctrine()->getManager();
    ...
    public function supprimerlikemobileAction(Request $request)
    {
        $em = $this->getDoctrine()->getManager();
        ...
        $nbrrr = $em->getRepository('EvenementBundle:LikeEve')->rechercherlikeid($request->get('iduser'), $request->get('ideve'));//recuperer id_par selon id_user et id_eve
        $pa = $this->getDoctrine()->getRepository(LikeEve::class)->find($nbrrr);//recuperer l objet participer
        $like->setIdLike($nbrrr);
    ...
    public function ajouterdislikemobileAction(Request $request)
    {
        $em = $this->getDoctrine()->getManager();
    ...
    public function supprimerdislikemobileAction(Request $request)
    {
        $em = $this->getDoctrine()->getManager();
    ...
    public function nbrlikemobileAction(Request $request)
    {

        $em = $this->getDoctrine()->getManager();
        $nbr = $em->getRepository('EvenementBundle:LikeEve')->nbrlike($request->get('ideve'));//nbr participons a une eve
    ...
    public function nbrdislikemobileAction(Request $request)
    {

        $em = $this->getDoctrine()->getManager();
        $nbr = $em->getRepository('EvenementBundle:LikeEve')->nbrdislike($request->get('ideve'));//nbr participons a une eve
