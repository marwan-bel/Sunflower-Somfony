...
class ProduitController extends Controller
{
     ...
     *
     */
    public function indexfrontmobAction(Request $request)
    {
        $em = $this->getDoctrine()->getManager();
        $produits = $em->getRepository('ProduitBundle:Produit')->findAll();
     ...
     *
     */
    public function categoriemobAction(Request $request)
    {
        $em = $this->getDoctrine()->getManager();
        $categ = $em->getRepository('ProduitBundle:CategorieProduit')->findAll();
    ...
    public function filtermobAction(Request $request)
    {
        $em = $this->getDoctrine()->getManager();

        $produitsfiltred = $em->getRepository('ProduitBundle:Produit')->listProduitByCategorie($request->get('nomCategorie') );

        $serializer = new Serializer([new ObjectNormalizer()]);
        $formatted = $serializer->normalize($produitsfiltred);
        return new JsonResponse($formatted);

    }

    public function mostratedmobAction(   )
    {
        $em = $this->getDoctrine()->getManager();

        $produitsmostrated = $em->getRepository('ProduitBundle:Produit')->listmostratedProduit();

        $serializer = new Serializer([new ObjectNormalizer()]);
        $formatted = $serializer->normalize($produitsmostrated);
        return new JsonResponse($formatted);

    }

    public function newestmobAction(   )
    {
        $em = $this->getDoctrine()->getManager();

        $produitsmostrated = $em->getRepository('ProduitBundle:Produit')->listnewestProduit();
